...
const ServiceCard = ({ data, index }) => {
    ...
    return (
        ...
        >
            ...
            <div className="w-full br-test lg:w-1/2 h-full flex items-center justify-center relative z-10">
                <h2 className="text-4xl br-test md:text-6xl lg:text-8xl font-boldonse transform -rotate-6 lg:-rotate-12 mix-blend-difference">
                    <span className="text-outline text-center">{data.name}</span>
                </h2>
            </div>

            <div ref={contentRef} className="w-full br-test lg:w-1/2 h-full flex flex-col justify-center relative z-10 p-4 md:p-8">

...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        {navLinks.map((link, i) => (
          <div key={i} ref={addToRefs} className="overflow-hidden mb-4">
            <Link
            ...
            >
              ...
              <span className="hover-text absolute left-0 top-0 inline-block">
                {"<>" + link.name + "</>"}
              </span>
            </Link>
          </div>
...
const TopNav = ({ open, handleToggle }) => {
  ...
  return (
    ...
    >
      ...
      <ModeToggle />
      <button className="text-white font-bold text-xl" aria-label="Toggle menu">
